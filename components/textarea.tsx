...
export default function Textarea({ label, name, placeholder = "请输入", required, defaultValue, value, onChange, className, size = 'md' }: TextareaProps) {
  const id = useId();
  return (
    <>
      ...
      <textarea name={name} id={id} placeholder={placeholder} value={value} defaultValue={defaultValue} className={classNames(
