...
export default function Button({ name, icon, className, type = "button", size = 'md', onClick }: ButtonProps) {
  return (
    <button type={type} className={classNames('select-none bg-text-normal text-bg-normal px-3 rounded-[12px] hover:cursor-pointer hover:bg-text-shallow active:bg-text-normal transition', className, {
